 ...
 */
const R2_GAME_URL =
  "https://pub-a2458a29274f4f5ba61f429adf2fcf8f.r2.dev/cosmic-slots/v8/index.html";
...
export function CosmicGodot({
  ...
  return <GameViewport ref={iframeRef} src={GAME_URL} title="Cosmic Slots" onLoad={sendInit} />;
}
