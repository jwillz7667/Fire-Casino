-- Seed the Leviathan's Deep catalog row.
--
...
-- and thumbnail are hosted on Cloudflare R2. sortOrder 0 features the new flagship first.
INSERT INTO "games" (
  ...
  'https://pub-a2458a29274f4f5ba61f429adf2fcf8f.r2.dev/leviathan-deep/thumb.png',
  '{"engine":"leviathan-deep","renderer":"leviathan-deep"}'::jsonb,
  0,
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
)
